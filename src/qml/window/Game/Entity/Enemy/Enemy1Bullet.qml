...
Item {
    ...
    property int spriteIndex: backend && backend.spriteIndex !== undefined ? Math.max(1, Math.min(9, backend.spriteIndex)) : 1

    Image {
        anchors.centerIn: parent
        source: "qrc:/resource/image/entity/enemy1Bullet" + spriteIndex + ".png"
